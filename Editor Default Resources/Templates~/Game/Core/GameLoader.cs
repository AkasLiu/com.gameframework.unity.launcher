...
namespace Game
{
    ...
    public static class GameLoader
    {
        ...
        /// 加载处理函数
        /// </summary>
        public static async UniTask Load(GameWorldCommandType commandType)
        {
            switch (commandType)
            {
                ...
                case GameWorldCommandType.Context:
                    // 加载上下文
                    await ContextLoader.Load();
                    break;
                case GameWorldCommandType.Configure:
                    // 加载配置表
                    await ConfigureLoader.Load();
                    break;
                default:
        ...
        /// 重载处理函数
        /// </summary>
        public static async UniTask Reload(GameWorldCommandType commandType)
        {
            switch (commandType)
            {
                case GameWorldCommandType.Assembly:
